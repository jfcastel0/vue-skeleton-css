    ...
    >
        <div class="content-container">
            <div class="spinner" :style="`visibility: ${spinnerVis}`">
                <div :class="`double-bounce1 ${primary && 'white'}`"></div>
                <div :class="`double-bounce2 ${primary && 'white'}`"></div>
            </div>
...
<style scoped>
    ...
    .double-bounce1.white, .double-bounce2.white {
